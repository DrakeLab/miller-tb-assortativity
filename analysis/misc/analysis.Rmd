...
# stats
country.who %>%
  filter(!is.na(mf_inc), !is.infinite(mf_inc)) %>%
  summarise(meanRat=mean(mf_inc), 
            sdRat=sd(mf_inc), 
            se=sdRat/n())
