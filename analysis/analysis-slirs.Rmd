...
```{r tauPlot, fig.cap="Agreement between analytical and numerical solutions. Horizontal grey line shows $I=1$ and vertical grey line shows approximately where $R_0=1$. Results are consistent for SIR and SLIR models. High assortativity increases $R_0$ for larger values of $\\tau$. No individual-level heterogeneity in transmission rates plotted here. ", fig.height=5.5}
