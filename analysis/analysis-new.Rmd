...
In this simulation study of pathogens spreading on contact networks, we sex-assortativity (r=0 to 0.6 by 0.1) and sex-trait ratios ($\alpha$) to see how the ratio of male-female cases changes. 
...
epiDyn %>%
  ...
  scale_fill_discrete_sequential(palette="Sunset") +
  labs(x="Strength of sex trait", y="", fill="Assortativity", title = "") +
  theme_bw() +
    guides(colour=FALSE) +
  theme(plot.title = element_text(face="bold", size=txs), 
    axis.text=element_text(size=txs),
