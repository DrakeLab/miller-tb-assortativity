...
Tau = [0.04] #[0.04, 0.075, 0.1, 0.15]         #  S->L Baseline transmission rate 
...
Alph_vals =  [3.0] #[1.0, 1.25, 1.5, 2.0, 3.0]   # Ratio of male:female susceptibility
...
with open("SLIRS-res/"+"sah_res_2.csv",'wb') as out:
